...
void MX_TIM1_Init(void)
{
  ...
  TIM_InitStruct.Autoreload = PWM_period - 1;
...
void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_ResetOutputPin(GPIOA, LL_GPIO_PIN_1|LL_GPIO_PIN_8|LL_GPIO_PIN_9|LL_GPIO_PIN_10);
